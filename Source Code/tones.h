...
static int Greendleves_notes[]={NOTE_G4,NOTE_AS4,NOTE_C5, NOTE_D5, NOTE_DS5, NOTE_D5, NOTE_C5, NOTE_A4, NOTE_F4, NOTE_G4, NOTE_A4, NOTE_AS4, NOTE_G4, NOTE_G4, NOTE_FS4, NOTE_G4,
...
static int Greendleves_notes_durations[]={8,4,8,-8,16,8,4,8,-8,16,8,4,8,-8,16,8,4,8,4,8,4,8,-8,16,8,
	4,8,-8,16,8,-8,16,8,-8,16,8,4,8,-8,16,8,-8,16,8,-8,16,8,-2,
2,16,8,4,8,-8,16,8,4,8,-8,16,8,4,8,04,2,16,8,4,8,-8,16,8};
static int Greensleves_notes_length = sizeof(Greendleves_notes) / sizeof(Greendleves_notes[0]) ;

/*star wars*/

static int starwars_notes[]={NOTE_AS4,NOTE_AS4, NOTE_AS4,NOTE_F5, NOTE_C6,NOTE_AS5, NOTE_A5,NOTE_G5, NOTE_F6, NOTE_C6,NOTE_AS5, NOTE_A5, NOTE_G5, NOTE_F6, NOTE_C6,
...
static int starwars_notes_durations[]={8,8,8,2,2,8,8,8,2,4,8,8,8,2,4,8,8,8,2,8,8,8,2,2,8,8,8,2,4,8,8,
	8,2,4,8,8,8,2,-8,16,-4,8,8,8,8,8,8,8,8,4,8,4,-8,16,-4,8,8,8,8,
8,-8,16,2,8,8,-4,8,8,8,8,8,8,8,8,4,8,4,-8,16,4,8,4,8,4,8,4,8,1};
static int starwars_notes_length = sizeof(starwars_notes) / sizeof(starwars_notes[0]) ;

/*game of throns*/

static int game_of_throns_notes[]={NOTE_G4, NOTE_C4, NOTE_DS4, NOTE_F4, NOTE_G4, NOTE_C4,NOTE_DS4,NOTE_F4,NOTE_G4, NOTE_C4, NOTE_DS4, NOTE_F4, NOTE_G4, NOTE_C4,
...
static int game_of_throns_notes_durations[]={8,8,16,16,8,8,16,16,8,8,16,16,8,8,16,16,8,8,16,16,8,8,16,16,8,8,16,16,8,8,16,16,
...
static int game_of_throns_notes_length = sizeof(game_of_throns_notes) / sizeof(game_of_throns_notes[0]) ;
/*harry potter*/

static int harry_potter_notes[]={  REST, NOTE_D4,NOTE_G4, NOTE_AS4, NOTE_A4,NOTE_G4, NOTE_D5,NOTE_C5,NOTE_A4,NOTE_G4, NOTE_AS4,NOTE_A4,NOTE_F4,NOTE_GS4,NOTE_D4,
...
static int harry_potter_notes_durations[]={2,4,-4,8,4,2,4,-2,-2,-4,8,4,2,4,-1,4,-4,8,4,2,4,2,4,2,4,-4,8,4,2,4,-1,4,2,
4,2,4,2,4,2,4,-4,8,4,2,4,-1,4,4,2,4,2,4,2,4,2,4,-4,8,4,2,4,-1};
static int harry_potter_notes_length = sizeof(harry_potter_notes) / sizeof(harry_potter_notes[0]) ;
